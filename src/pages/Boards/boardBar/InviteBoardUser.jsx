...
import { inviteUserToBoardAPI } from '~/apis/axios'
...
function InviteBoardUser({ boardId }) {
  ...
  */
  ...
  const submitInviteUserToBoard = async(data) => {
    ...
    // gọi api gọi mời một người vào làm thành viên của board 
    await inviteUserToBoardAPI({ inviteeEmail, boardId }).then((invitation) => {

      // Clear thẻ input sử dụng react-hook-form bằng setValue
      setValue('inviteeEmail', null)
      setAnchorPopoverElement(null)

      // mời một người dùng vào board xong thì củng sẽ gửi mail sự kiện soket lên server (tính năng real time)
      // gửi sự kiện socket lên BE
